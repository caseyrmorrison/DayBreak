...
**Documentation:** [User guide](docs/USER-GUIDE.md) · [Cheat sheet](docs/CHEATSHEET.md) · [Architecture](docs/ARCHITECTURE.md) · [iOS app](ios/README.md) · [Android app](android/README.md)
